...
open class SelectionBox: SKShapeNode, SuperTouchable {
    
    public func _touchBegan() {
        superChatBox.selected(id)
    }
    public func _touchReleased() {}
    public func _touchEndedOn() {}
    public var touchBegan: (SelectionBox) -> () = {_ in}
    public var touchReleased: (SelectionBox) -> () = {_ in}
    public var touchEndedOn: (SelectionBox) -> () = {_ in}
    
    public var id: Int = 0
    public var superChatBox: ChatBox!
    
    public static func Make(id: Int, words: [String], width: CGFloat, corner: CGFloat) -> SelectionBox {
...
open class ChatBox: SKShapeNode {
    
    public var _next = false
    public var _result: Communication?
    public func next() {
        if !options.isEmpty {
    ...
    public var options: [(SelectionBox, Communication)] = []
    
    public var selected = -1
    public func selected(_ thisId: Int) {
    ...
    public func moveSelection(_ d: Int) {
        selected(selected + options.count - d)
    }
    
    public func addSelection(words: [String], result: Communication) {
    ...
    public static func Make(words: [String], width: CGFloat, corner: CGFloat) -> ChatBox {
        let scale: CGFloat = 1
